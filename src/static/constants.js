...
const deutsch = new Skill('Deutsch', '5', '')
const languageLevels = [hungarian, english, deutsch]



const epam = new ProgExperience('Software Enginieer', 'EPAM System', 'https://www.epam.com/', '2022-Present', 'Develop java REST(ful) APIs using Spring(Core, Boot, MVC, Data, Security, AOP)', 'Java, Hibernate, Gradle, JUnit4, Mockito, Jacoco, AWS')
...
const dog1 = new Image('Masni', 'Masni 1.st day', Masni1);
const dog2 = new Image('Masni 1.st snow', 'Masni 1.st snow', Masni2);
const dog3 = new Image('Masni big leaf', 'Masni big leaf', Masni3);
const masni = [dog1, dog2, dog3]

export { masni, volunteering, schools, languageLevels, progexp, programmingLevels, socials, serverIp };